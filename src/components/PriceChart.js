...
const showPriceChart = (priceChart, symbol) => {
  return(
    <div className="price-chart">
      <div className="price">
        <h4>{symbol}/MATIC &nbsp; {priceSymbol(priceChart.lastPriceChange)} &nbsp; {priceChart.lastPrice}</h4>
      </div>
    ...
    return (
      <div className="card bg-dark text-white">
        ...
        <div className="card-body">
          {this.props.priceChartLoaded ? showPriceChart(this.props.priceChart, this.props.symbol) : <Spinner />}
        </div>
      </div>
    )
  }
